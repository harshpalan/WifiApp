...
public class MainActivity extends AppCompatActivity {
    ...
    public void wifitoggle(WifiManager wm, TextView toggle) {
        if (wm.isWifiEnabled()) {
            ...
            toggle.setText("OFF");
            toggle.setBackgroundColor(Color.rgb(240, 148, 138));
            ...
            toggle.setText("ON");
            toggle.setBackgroundColor(Color.rgb(130, 230, 150));
    ...
    public String returnlevel(int DBm) {
        ...
        else if (DBm >= -60) return DBm + " dBm > Good";
        else if (DBm >= -70) return DBm + " dBm > Fair";
                ...
                conn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        try {
                            ...
                            File myFile = new File(dir, "Wifi_Log.txt");
                            if (myFile.length() < 1024000) {
                                FileWriter fw = new FileWriter(myFile, true);
                                BufferedWriter bw = new BufferedWriter(fw);
                                PrintWriter pw = new PrintWriter(bw);
                                String printString = "Time & date" + formattedDate + "  SSID :" + ssid + "\tSingal Strength: " + ss + "dB\t" + "Link Speed: " + ls + "\n";
                                pw.print(printString);
                                Toast.makeText(MainActivity.this, "Added it into file", Toast.LENGTH_SHORT).show();
                                pw.close();
                            } else {
